...
par(mfrow=c(2,2))
with(file,{
  plot(file$DateTime,file$Global_active_power,type="line",xlab="",ylab="Global Active Power")
  
  plot(file$DateTime,file$Voltage,type="line",xlab="datetime",ylab="Voltage")
  ...
  plot(file$DateTime,file$Global_reactive_power,type="line",xlab="datetime",ylab="Global_reactive_power")
})